...
from mare.metric import RelationMetric
from mare.utils import compounding





@Model.register("delta_crf_bert")
class SequenceTagger(Model):
    ...
    def get_predicted_spans(self, predicted_tags, logits):
